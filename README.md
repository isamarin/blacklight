...
**Versioning:** [CalVer](https://calver.org/) (`2026.7.4`). Release tags: `v2026.7.4` (not the old fork `v3.*` prefix).
...
Release tag (triggers CI draft release with DMG + NSIS):
    ...
    git tag -a v2026.7.4 -m "Blacklight 2026.7.4"
    git push origin v2026.7.4
