...
**Versioning:** [CalVer](https://calver.org/) (`2026.7.11`). Release tags: `v2026.7.11` (not the old fork `v3.*` prefix).
...
Release tag (triggers CI draft release with DMG + NSIS):
    ...
    git tag -a v2026.7.11 -m "Blacklight 2026.7.11"
    git push origin v2026.7.11
